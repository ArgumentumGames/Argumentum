...
namespace Argumentum.CsvValidator
{
	public class Fallacy : CsvBase<Fallacy, FallacyClassMap>, IMindMapItem, ICsvBase
	{
        ...
        public string DecimalPath { get; set; } = null!;
        public int Depth { get; set; }
        public string Famille { get; set; } = null!;
        public string FamilleCamelCase { get; set; } = null!;
        public string SousFamille { get; set; } = null!;
        public string Soussousfamille { get; set; } = null!;
        public string État { get; set; } = null!;
        public int? Carte { get; set; }
        public int? Niveau { get; set; }
        public string NomVulgarisé { get; set; } = null!;


        public string TextFr { get; set; } = null!;
        public int? LTfr { get; set; }

        public string DescFr { get; set; } = null!;
        public int? Lfr115 { get; set; }
        public string ExampleFr { get; set; } = null!;
        public int? Lxfr145 { get; set; }

        public string LinkFr { get; set; } = null!;

        public string Subfamily { get; set; } = null!;
        public string Subsubfamily { get; set; } = null!;

        public string TextEn { get; set; } = null!;
        public int? LTen { get; set; }

        public string SimpleNameEn { get; set; } = null!;
        ...
        public string ExampleEnBis { get; set; } = null!;

        public string LinkEn { get; set; } = null!;
        public int? Lxen145 { get; set; }
        public string Remarques { get; set; } = null!;

        public string Latin { get; set; } = null!;

        public string ExemplePolitique { get; set; } = null!;
        public string PoliticalExampleEn { get; set; } = null!;
        public string Proverbe { get; set; } = null!;


        public string FamilyRu { get; set; } = null!;
        public string SubfamilyRu { get; set; } = null!;
        public string SubsubfamilyRu { get; set; } = null!;


        public string TextRu { get; set; } = null!;

        public string DescRu { get; set; } = null!;

        public string Exampleru { get; set; } = null!;

        public string LinkRu { get; set; } = null!;

        public string FamilyPt { get; set; } = null!;
        public string SubfamilyPt { get; set; } = null!;
        public string SubsubfamilyPt { get; set; } = null!;

        public string TextPt { get; set; } = null!;

        public string DescPt { get; set; } = null!;

        public string ExamplePt { get; set; } = null!;

        public string LinkPt { get; set; } = null!;

        public string PlusLienstransverses { get; set; } = null!;
        public string TypeLienTransverse { get; set; } = null!;
        public string Shape { get; set; } = null!;
        public string Image { get; set; } = null!;
        public string SvgColor { get; set; } = null!;
        public string SvgIllustration { get; set; } = null!;

        public string AIFSkosDirectRef { get; set; } = null!;

        public string AIFSkosExceptionRef { get; set; } = null!;

        public string AIFSkosOther { get; set; } = null!;

        public string AIFSkosMappingType { get; set; } = null!;


		public int? PrintAndPlay { get; set; }

        public string DécimalPathPadded { get; set; } = null!;

        public string DepthMax4 { get; set; } = null!;
	}
