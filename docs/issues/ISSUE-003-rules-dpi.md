...
- [ ] Change DPI to 300 in `Argumentum_Rules_fr.json`
- [ ] Change DPI to 300 in `Argumentum_Rules_Back_fr.json`
- [ ] Regenerate Rules images
- [ ] Validate dimensions match expected tarot size (60×113mm)
