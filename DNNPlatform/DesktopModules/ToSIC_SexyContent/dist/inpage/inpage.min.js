...
var ToSxcName = "2sxc";
/** @internal */
var constants_SxcVersion = "15.02.00";
/** @internal */
...
/** @internal */
var TlbHoverPrefix = 'sc-tb-hover-';
/** @internal */
var TlbShowPrefix = 'sc-tb-show-';
/** @internal */
...
/** @internal */
var TLB_HOV_TOP = 'top'; // not in use ATM / default
/** @internal */
var TLB_HOV_MID = 'middle';
/** @internal */
var TLB_HOV_BOT = 'bottom'; // not in use ATM / not implemented
/** @internal */
...
var ToolbarSettings = /** @class */ (function () {
    ...
    ToolbarSettings.bestAddMorePos = function (settings) {
        ...
        if (result === TLB_MORE_AUTO)
            return ((_b = settings === null || settings === void 0 ? void 0 : settings.hover) === null || _b === void 0 ? void 0 : _b.startsWith(TLB_HOV_LEFT) /* === TLB_HOV_LEFT */) ? TLB_MORE_START : TLB_MORE_END;
...
var TagToolbar = /** @class */ (function () {
    ...
    TagToolbar.prototype.updatePosition = function (initial) {
        ...
        var tagClasses = this.toolbarElement.classList;
        if (trackMouse)
            position.top = position.mousePos.y + position.win.scrollY - position.bodyOffset.top - (ToolbarHeight / 2);
        else if (tagClasses.contains(TlbHoverPrefix + TLB_HOV_MID))
        ...
        var tlbStyle = this.toolbarElement.style;
        tlbStyle.top = typeof position.top === 'number' ? "".concat(position.top, "px") : position.top;
        tlbStyle.left = typeof position.left === 'number' ? "".concat(position.left, "px") : position.left;
        tlbStyle.right = typeof position.right === 'number' ? "".concat(position.right, "px") : position.right;
    };
    /**
...
var ToolbarRenderer = /** @class */ (function (_super) {
    ...
    ToolbarRenderer.prototype.generate = function () {
        ...
        var hover = (_b = settings.hover) === null || _b === void 0 ? void 0 : _b.split('-'); // in case it has two values, like right-middle
        hover === null || hover === void 0 ? void 0 : hover.forEach(function (h) { return tlbTag.classList.add("".concat(TlbHoverPrefix).concat(h)); });
        tlbTag.classList.add("".concat(TlbShowPrefix).concat(settings.show));
...
NoJQ.ready(function () {
    ...
    function toggleAllToolbars() {
        document.body.classList.toggle("".concat(TlbShowPrefix, "all"));
    }
...
/******/ })()
;
//# sourceMappingURL=https://sources.2sxc.org/15.02.00/inpage/inpage.min.js.map