<%@ Control Language="C#" AutoEventWireup="false" Inherits="DotNetNuke.Modules.Admin.EditExtension.EditExtension" Codebehind="EditExtension.ascx.cs" %>
...
<div class="dnnForm dnnEditExtension dnnClear" id="dnnEditExtension">
    ...
    <div id="packageSettingsSection" runat="server">
