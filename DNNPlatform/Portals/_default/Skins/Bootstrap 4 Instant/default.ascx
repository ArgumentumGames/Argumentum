              ...
              <ul class="ly-footer-address clearfix" itemscope itemtype="http://schema.org/LocalBusiness">
				...
				<li>
					<span itemprop="address" itemscope itemtype="http://schema.org/PostalAddress">
						<span itemprop="streetAddress">41 rue de Tanger</span>,
						<span itemprop="postalCode">75019</span>
						<span itemprop="addressLocality">Paris</span>,
						<span itemprop="addressCountry">France</span>
					</span>
				</li>
                <li><i class="fas fa-phone"></i>&nbsp;<a href="tel:+33689687966">+33 6 89 68 79 66</a></li>
				<li>
					<i class="far fa-envelope"></i>&nbsp;<span data-madr1="instant" data-madr2="example" data-madr3="com" data-linktext="contact@argumentum.games"></span>
				</li>
            </ul>
